...
const RadialGradientBackground = ({variant='hero', gradients=[]}) => {
    ...
    hero: [
      {
        ...
        colors: [
          { color: "rgba(141, 246, 233, 0.12)", stop: "10%" },
          { color: "rgba(141, 246, 233, 0.20)", stop: "100%" },
          { color: "rgba(141, 246, 233, 0.24)", stop: "100%" },
          { color: "rgba(141, 246, 233, 0.20)", stop: "100%" },
          { color: "rgba(141, 246, 233, 0.12)", stop: "100%" }
        ],
        blur: "0px",
        opacity: 0.32,
      },
  ...
  const generateGradient = (colors) => {
    const colorStop =colors.map(({color, stop})=> `${color} ${stop}`).join(', ');
