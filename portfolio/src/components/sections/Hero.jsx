      ...
      <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          ...
          <div className='text-left'>
            ...
            <FadeIn delay={100}>
              <h1 className='text-5xl md:text-5xl lg:text-6xl font-normal text-white mb-6 leading-tight'>
            ...
            <FadeIn delay={200}>
              <p className='text-lg text-white/70 max-w-[550px] mb-8'>
                Student la licență în Calculatoare și Tehnologia Informației, interesat de dezvoltarea 
                aplicațiilor software și a sistemelor embedded. Lucrez la proiecte
                personale și academice care includ aplicații web și backend, inteligență
                artificială și aplicații mobile Android.
              </p>
            </FadeIn>
                ...
                <div className="absolute bottom-6 left-6 z-20">
                  <FadeIn delay={500}>
                    <div className="flex items-center gap-4 bg-black/40 backdrop-blur-sm border border-white/10 rounded-full px-6 py-3">
                      ...
                      <div className="w-6 h-6 flex items-center justify-center hober:scale-110 transition-transform duration-300">
                        <FaMicrochip className="w-full h-full text-primary" />
                      </div>
                    </div>
                  </FadeIn>
                </div>
