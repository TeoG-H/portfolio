        ...
        <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full'>
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            ...
            <div className='text-left'>
              <FadeIn delay={0}>
                <div className='inline-flex items-center gap-2.5 px-[18px] py-[11px] 
                mb-8 bg-linear-to-r from-primary/10 via-primary/15 to-primary/20 border border-primary/20 rounded-full'>
              ...
              <FadeIn delay={100}>
                <h1 className='text-4xl md:text-5xl lg:text-6xl font-normal text-white mb-6 leading-tight'>
                  Software Engineering Student – Multi-domain Applications
              ...
              <FadeIn delay={200}>
                <p className='text-lg text-white/70 max-w-[550px] mb-8'>
                  I am a third-year student at the Faculty of Automatic Control and Computer Engineering in Iași, 
focused on building practical software projects across multiple IT domains. 
My experience includes web and full-stack applications, backend systems, 
embedded projects, mobile apps, and AI-based solutions.
                </p>
              </FadeIn>
              ...
              <div className="relative">
                <div className="relative overflow-hidden rounded-2xl aspect-4/5 max-w-[500px] ml-auto group">
                  ...
                  <div className="relative rounded-2xl overflow-hidden m-[1px] h-[calc(100%-2px)]">
                    <img src="/profile.jpeg" alt="Developer at work"
                  ...
                  <div className="absolute bottom-6 left-6 z-20">
                    <FadeIn delay={500}>
                      <div className="flex items-center gap-4 bg-black/40 backdrop-blur-sm border border-white/10 rounded-full px-6 py-3">
                        <div className='w-6 h-6 flex items-center justify-center hober:scale-110 transition-transform duration-300'>
