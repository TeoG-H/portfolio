...
const Contact = () => {
 ...
 return (
  //py-20 mai jos
  <section id="contact" className="relative py-2 bg-black overflow-hidden">
              ...
              {status.message && (
                <div
                  className={`p-4 rounded-xl ${
                    status.type === 'success'
                      ? 'bg-[#8DF6E9]/10 border border-[#8DF6E9]/30 text-[#8DF6E9]'
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <a
                                    ...
                                    className="text-white hover:text-[#6EE7F2] transition-colors font-medium">
                                    {PERSONAL_INFO.email}
                                </a>
                            </div>
                        </div>
